# PowerShell script to enable Ultimate Performance power plan and set it as active
# Set-ExecutionPolicy -Scope Process -ExecutionPolicy RemoteSigned
# Created by Jason Prespolis | 5:57 PM 5/25/2024 | for Windows 10/11 Enterprise

# Define the GUID for the Ultimate Performance power plan
...
Write-Host "Performance power plan enabled and set as active."
